...
| Health Check | `agent-qa/commands/health-check/health-check.md` | Verify configuration and MCP connectivity |
| Validate Outputs | `agent-qa/commands/validate-outputs/validate-outputs.md` | Validate deliverables against QA rules |
| Traceability Report | `agent-qa/commands/generate-traceability-report/generate-traceability-report.md` | Cross-deliverable coverage matrix |
| Generate Test Data | `agent-qa/commands/generate-test-data/generate-test-data.md` | Generate structured test data sets |
| Run Pipeline | `agent-qa/commands/run-pipeline/run-pipeline.md` | Execute multiple commands in sequence |
| Generate API Tests | `agent-qa/commands/generate-api-tests/generate-api-tests.md` | Generate REST/GraphQL API test specs |
| Generate Accessibility Tests | `agent-qa/commands/generate-accessibility-tests/generate-accessibility-tests.md` | Generate WCAG 2.1 AA accessibility tests |
| Regenerate | `agent-qa/commands/regenerate/regenerate.md` | Regenerate deliverables affected by requirement changes |
