...
Valid `type` values: `requirement`, `test-cases`, `test-strategy`, `test-charter`, `test-plan`, `risk-register`, `release-notes`, `commit-analysis`, `gherkin-feature`, `playwright-spec`
